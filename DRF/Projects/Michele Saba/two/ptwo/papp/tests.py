...
from papp.serializers import ProfileSerial, ProfileAvatarSerial, ProfileStatusSerial
from papp.models import Profile, ProfileStatus
...
class ProfileStatusViewSetTestCase(APITestCase):
    ...
    def test_single_status_retrieve(self):
        serializer_data = ProfileStatusSerial(instance=self.status).data
